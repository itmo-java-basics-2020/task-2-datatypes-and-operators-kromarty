...
public class Task2 {
    ...
    boolean numberInRange(Integer number, Integer leftBound, Integer rightBound, Boolean inclusively) {
        ...
        else return (number.intValue()>leftBound.intValue() && number.intValue()<rightBound.intValue()) ;//your code here
    }
    ...
    boolean atLeastOneIsDigit(char c1, char c2, char c3) {
        return (((int)c1>=48 && (int)c1<=57) || ((int)c2>=48 && (int)c2<=57) || ((int)c3>=48 && (int)c3<=57)); //your code here
    }
    ...
    boolean areRealNumbersEqual(double a, double b) {
        return ((a - b) <= 1E15 || (b - a) <= 1E15); //your code here
    }
    ...
    int sumOfDigits(int n) {
        return n/100+n%10+n/10%10; //your code here
    }
